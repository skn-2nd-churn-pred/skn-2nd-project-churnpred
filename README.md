...
| 이양원 | *(계정 확인 필요)* | 데이터 전처리 · EDA | 노트북 00·01, 데이터 품질 점검, EDA 7종, 전처리 결과서 작성 |
| 김유진 | [@ujinkim2001](https://github.com/ujinkim2001) | 모델링 · 평가 | 노트북 02, 모델 비교 실험, Dummy 기준선·PR-AUC 도입, 학습 결과서 |
| 김성훈 | *(계정 확인 필요)* | 군집분석 | 노트북 03, K-Means 세그먼트 분석, 군집 결과서 |
...
- [ ] 모든 팀원의 GitHub 계정이 연결되어 있습니다. *(이양원·김성훈 계정 확인 필요)*
